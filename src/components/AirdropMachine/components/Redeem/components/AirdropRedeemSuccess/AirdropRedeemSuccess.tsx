...
export default function AirdropRedeemSuccess() {
  ...
  return (
    <div className="airdrop-redeem-success-wrapper">
      ...
      <div className="airdrop-redeem-success__title">{t("AirdropMachine.AirdropRedeemSuccess.title")}</div>
      <span className="airdrop-redeem-success__sub-title">{t("AirdropMachine.AirdropRedeemSuccess.sub-title")}</span>
      {t("AirdropMachine.AirdropRedeemSuccess.text-1")}
      <b>{t("AirdropMachine.AirdropRedeemSuccess.text-2")}</b>
      <div className="airdrop-redeem-success__features-wrapper">
        <div className="airdrop-redeem-success__feature">
          ...
          {t("AirdropMachine.AirdropRedeemSuccess.text-3")}
        </div>
        <div className="airdrop-redeem-success__feature">
          <img src={RadioButtonChecked} alt="radio button" />
          {t("AirdropMachine.AirdropRedeemSuccess.text-4")}
        </div>
        <div className="airdrop-redeem-success__feature">
          <img src={RadioButtonChecked} alt="radio button" />
          {t("AirdropMachine.AirdropRedeemSuccess.text-5")}
        </div>
      </div>
      ...
      <button className="airdrop-redeem-success__join-embassy-btn" onClick={() => window.open(DISCORD_ENTRY_CHANNEL)}>
        <DiscordIcon />
        &nbsp;
        {t("AirdropMachine.AirdropRedeemSuccess.button-text")}
      </button>
    </div>
  )
}
