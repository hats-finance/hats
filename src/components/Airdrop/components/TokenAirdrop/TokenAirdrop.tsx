  ...
  const renderStage = (stage: Stage) => {
    switch (stage) {
      ...
      case Stage.ChooseDelegatee:
        return <ChooseDelegatee setDelegatee={setDelegatee} />;
      case Stage.Claim:
        return <Claim delegatee={delegatee!} address={address} tokenAmount={tokenAmount} eligibleTokens={eligibleTokens} />;
    }
  }
